...
2) Método acelerar, que deverá incrementar a velocidade em 1 unidade
3) Método frear, que deverá decrementar a valecidade em 2 unidades

A direção terá a responsabilidade de controlar a direção. Ela oferece os seguintes atributos:
1) Valor de direção possíveis: Norte, Sul, Leste e Oeste
2) Método girar_direta
...
class Direcao():
    ...
    rotacao_esquerda = {LESTE: NORTE, SUL: LESTE, OESTE: SUL, NORTE: OESTE}
    def __init__(self):
        self.valor = NORTE
